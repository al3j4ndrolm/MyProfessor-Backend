...
from data_fetchers.school_data.schools.ccsf import departments
from tests.data_fetchers.schools.base_test import BaseSchoolTest

sys.path.append(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))) )

class TestCCSFDepartments(BaseSchoolTest):
    @property
    ...
    def test_get_department_data_table(self):
        ...
        soup = self.load_test_html_data("departments_test_sample.html")
