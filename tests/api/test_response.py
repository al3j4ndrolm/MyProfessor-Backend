...
from api.response import response_start, response_schools
...
class TestResponse:
    ...
    def test_response_schools(self):
        """Test response_schools function"""
        ...
        with patch('api.response.schools_db.get_supported') as mock_get_supported, \
            ...
            # Verify broadcast list (old format)
            broadcast_list = result[configs.SCHOOLS_KEY_BROADCASTS]
            assert len(broadcast_list) == 1
